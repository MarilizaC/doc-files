...
<table>
  <tr>
    ...
    <td valign="top" width="40%"> Hourly price, in GoodWill, per container size, </br> that is charged when using a peer’s resources. </br> Beside each price is an arrow that indicates </br> its increase or decrease compared to the previous value. </td>
  ...
  <tr>
    ...
    <td valign="top" width="40%"> Number of AppScale templates on clusters, </br> containers, and peers </td>
    <td valign="top"> <img src="https://github.com/MarilizaC/icons/blob/master/Screenshot%20-%20StatisticsPrices.png" /> </td>
  </tr>
  <tr>
    <td valign="top"> Peers & Users dynamic statistics </td>
    <td valign="top" width="40%"> Graph that shows the comparison of total peers </br> and users per month. Hover over the bars to view </br>  the actual values. </td>
